...
export default function WorkWeekView({ viewSelector, initialDate, onDateChange }){
  const today = dayjs();
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="text-lg font-semibold text-slate-900 dark:text-slate-100 min-w-[250px] text-center">
            {workWeekDays[0].format('MMM D')} - {workWeekDays[4].format('MMM D, YYYY')}
          </div>
